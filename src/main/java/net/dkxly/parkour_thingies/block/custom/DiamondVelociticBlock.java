...
public class DiamondVelociticBlock extends Block {
    public static BlockPos blockPos = new BlockPos(1, 10000, 1);

    public DiamondVelociticBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        blockPos = pos;
        StatusEffectInstance statusEffectInstance = new StatusEffectInstance(ParkourThingiesStatusEffects.DIAMOND_VELOCITIC_EFFECT, 5, 0, true, false, false);
