...
public class VelocityPacketS2C extends PacketByteBuf {
    public static final Identifier ID = new Identifier(ParkourThingies.MOD_ID, "dash_velocity_packet");
    ...
    public static @Nullable Vec3d read(PacketByteBuf buf) {
        try{
            ...
            ParkourThingies.LOGGER.warn("No value in the packet while reading, probably not a big problem");
            return null;
        }catch (Exception e){
            ParkourThingies.LOGGER.error("There was an error while reading the packet!");
            e.printStackTrace();
            return null;
        }
